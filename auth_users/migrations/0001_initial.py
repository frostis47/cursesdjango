    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_attempt', models.IntegerField(default=0, verbose_name='Всего попыток рассылки')),
                ('successful_attempt', models.IntegerField(default=0, verbose_name='Успешных попыток рассылки')),
                ('unsuccessful_attempt', models.IntegerField(default=0, verbose_name='Неуспешных попыток рассылки')),
